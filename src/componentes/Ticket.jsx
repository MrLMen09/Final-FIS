  ...
  <div class="ticket" aria-hidden="true">
    <div class="ticket__header">
      <div class="ticket__co">
        ...
        <span class="ticket__co-name">Cine Jungla</span>
        <span class="u-upper ticket__co-subname">Multiplex</span>
      </div>
    </div>
    <div class="ticket__body">
      <p class="ticket__route">{props.titulo}</p>
      <div class="ticket__timing">
        <p>
          <span class="u-upper ticket__small-label">Hora</span>
          {funcion.map((f) => (
            <span class="ticket__detail">{f.horainicial}</span>
          ))}
          
        </p>
        <p>
          <span class="u-upper ticket__small-label">Sala</span>
          {funcion.map((f) => (
            <span class="ticket__detail">{f.codigoSala}</span>
          ))}
          
        </p>
      </div>
      <p class="ticket__fine-print">Recuerde llegar un poco antes</p>
